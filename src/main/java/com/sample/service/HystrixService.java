...
public class HystrixService {
  ...
  public String selfInvocation() {
    System.out.println(Thread.currentThread().getName() + ": selfInvocation call");
    return getContent();
  }

  @HystrixCommand(groupKey = HttpWebClient.GROUP, commandKey = HttpWebClient.COMMAND_GET_NESTED,
      threadPoolKey = HttpWebClient.THREAD_POOL_KEY,
      ignoreExceptions = {IgnoreRuntimeException.class})
  public String selfInvocationWithAnnotation() {
    System.out.println(Thread.currentThread().getName() + ": selfInvocationWithAnnotation call");
    return getContent();
  }
  ...
  public String getContent() {
    System.out.println(Thread.currentThread().getName() + ": getContent call");
